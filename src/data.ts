...
export const projects = [
  ...
  {
    title: 'PeopleCore HRMS',
    tagline: 'Role-based HR Management Platform',
    description:
      'A comprehensive HRMS covering employee management, attendance, leave, recruitment and HR workflows with role-based access control.',
    tech: ['Next.js', 'React', 'PostgreSQL', 'REST APIs', 'Tailwind CSS'],
    icon: Users,
    featured: false,
  ...
  },
  {
    ...
    description:
      'A human resource management system with attendance, leave, payroll workflows and JWT-based authentication.',
    tech: ['React', 'ASP.NET MVC', 'SQL Server', 'JWT'],
    icon: Briefcase,
    featured: false,
    gradient: 'from-navy-600 to-navy-800',
    badgeBg: 'bg-navy-50',
    badgeText: 'text-navy-700',
    badgeBorder: 'border-navy-200',
    cardClass: '',
  },
  {
    title: 'AMC College Management',
    tagline: 'College Management System',
    description:
      'A college management system with CRUD operations, authentication and role-based access for students, faculty and administrators.',
    tech: ['React', 'REST APIs', 'MySQL', 'Bootstrap'],
    icon: Cpu,
    featured: false,
  ...
  {
    title: 'MyLekkha',
    tagline: 'Invoice Management Application',
    description:
      'A business-focused invoice management application with invoice generation, item management and barcode functionality for efficient billing operations.',
    tech: ['React', 'REST APIs', 'Barcode', 'Tailwind CSS'],
    icon: Receipt,
    featured: false,
